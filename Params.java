...
public class Params {
/*	public final static int world_width = 3; //160
	public final static int world_height = 3; //80
	...
	*/
	public static int world_width = 3; //160
	public static int world_height = 3; //80
